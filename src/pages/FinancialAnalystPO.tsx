              ...
              <table className="w-full text-sm min-w-[2000px]">
                <thead className="bg-muted/50 border-b border-border sticky top-0">
                  ...
                  <tr className="bg-muted/30">
                    <td className="px-4 py-2 sticky left-0 bg-muted/30 z-10"></td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.expenseCategory || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, expenseCategory: e.target.value }))}
                    ...
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.costPool || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, costPool: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.swUsageCategory || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, swUsageCategory: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.swCategory || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, swCategory: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.deptNumber || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, deptNumber: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.poNumber || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, poNumber: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.poNumberSecondary || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, poNumberSecondary: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.cogsOpex || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, cogsOpex: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.level2Leader || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, level2Leader: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <Input
                        placeholder="Search..."
                        value={columnSearches.level3Leader || ""}
                        onChange={(e) => setColumnSearches(prev => ({ ...prev, level3Leader: e.target.value }))}
                        className="h-8 text-xs"
                      />
                    </td>
